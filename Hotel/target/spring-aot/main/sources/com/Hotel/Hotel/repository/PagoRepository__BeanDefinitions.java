...
/**
 * Bean definitions for {@link PagoRepository}.
 */
@Generated
public class PagoRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'pagoRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getPagoRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'pagoRepository'.
   */
  public static BeanDefinition getPagoRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, PagoRepository.class, Pago.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.Hotel.Hotel.repository.PagoRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.PagoRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.Hotel.Hotel.repository.PagoRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getPagoRepositoryInstanceSupplier();
